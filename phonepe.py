...
if select == "HOME":
    ...
    with col2:
        st.image(Image.open(r"C:/Users/karan/OneDrive/Pictures/Screenshots/phonepe.jpeg"),width= 600)
    ...
    with col6:
        st.image(Image.open(r"C:/Users/karan/OneDrive/Pictures/Screenshots/images (1).png"),width= 600)
